...
class CreateBookingFormScreen extends StatelessWidget {
  const CreateBookingFormScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => CreateBookingViewModel(),
      child: Scaffold(
        appBar: CustomAppBar(title: context.localization.createBooking),
        body: Consumer<CreateBookingViewModel>(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: viewModel.incrementAdults,
                          child: Text("+", style: TextStyle(fontSize: 25.sp)),
                        ),
                        Text(
                          viewModel.adultsCount.toString(),
                          style: TextStyle(
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w400,
                          ),
                        ...
                        GestureDetector(
                          onTap: viewModel.decrementAdults,
                          child: Text("-", style: TextStyle(fontSize: 25.sp)),
                        ),
                      ],
                    ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: viewModel.incrementKids,
                          child: Text("+", style: TextStyle(fontSize: 25.sp)),
                        ),
                        Text(
                          viewModel.kidsCount.toString(),
                          style: TextStyle(
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w400,
                          ),
                  ...
                  DropdownButtonFormField2<String>(
                    ...
                    onChanged: viewModel.setEthnicity,
                    items: viewModel.ethnicities.map<DropdownMenuItem<String>>((
                      String value,
                    ) {
                  ...
                  GestureDetector(
                    ...
                    child: AbsorbPointer(
                      child: TextFormField(
                        controller: TextEditingController(
                          text: viewModel.getFormattedTime(context),
                        ),
                        decoration: const InputDecoration(
                          hintText: "HH:MM",
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        // You might want to validate the form in viewModel first
