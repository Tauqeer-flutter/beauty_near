...
class BarberDetailScreen extends StatelessWidget {
        ...
        slivers: [
          ...
          Consumer<CreateBookingViewModel>(
            builder: (context, bookingViewModel, child) {
              return _buildBody(context, bookingViewModel);
            },
          ),
        ],
      ),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            customRatingRow(ratingNumber: "5", barLenght: 100),
                            SizedBox(height: 8.h),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                if (createBookingViewModel.selectedServices.isNotEmpty) ...[
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, selectServicesOrderSummary);
                    },
                    child: Container(
  ...
  Container _buildAvailabilityInfo(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(Iconsax.clock, color: AppColors.greenColor, size: 24.sp),
          SizedBox(width: 8.w),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: createBookingViewModel.selectedTabIndex == 0
                    ? null
                    : Colors.white,
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: createBookingViewModel.selectedTabIndex == 1
                    ? null
                    : Colors.white,
                borderRadius: BorderRadius.circular(70.r),
              ),
