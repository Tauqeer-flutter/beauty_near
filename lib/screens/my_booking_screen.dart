...
import '../view_models/my_booking_view_model.dart';
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: Consumer<MyBookingViewModel>(
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Tab navigation
                  _buildTabNavigation(context, viewModel),
                  SizedBox(height: 20.h),
                  // ListView with booking cards
                  _buildBookingsList(context, viewModel),
                ],
              ),
            );
          },
      ...
      children: [
        Expanded(
          child: GestureDetector(
            onTap: viewModel.selectUpcomingTab,
            child: Container(
              margin: EdgeInsets.only(right: 10.w),
              height: 35.h,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(70.r),
                gradient: viewModel.isUpcomingSelected
                    ? AppColors.kPrimaryGradient
                    : null,
                color: viewModel.isUpcomingSelected ? null : Colors.white,
              ),
              child: Center(
                child: Text(
                  context.localization.upcoming,
                  style: TextStyle(
                    color: viewModel.isUpcomingSelected
                        ? Colors.white
                        : AppColors.greyColor,
  ...
  Widget _buildBookingsList(
    ...
    return Expanded(
      child: ListView.builder(
        itemCount: viewModel.currentBookings.length,
        padding: EdgeInsets.only(bottom: context.notchAwareBottomPadding),
        itemBuilder: (context, index) {
          final booking = viewModel.currentBookings[index];
          ...
          if (viewModel.isUpcomingSelected) {
            return MyBookingCard(
              ...
              onViewDetails: () =>
                  viewModel.navigateToBookingDetails(context, false),
              onCancel: () => viewModel.cancelBooking(index),
            );
          } else {
            return MyBookingCardPast(
              ...
              dayNumber: booking.dayNumber,
              onViewDetails: () =>
                  viewModel.navigateToBookingDetails(context, true),
              onMarkComplete: () => viewModel.markBookingAsComplete(index),
            );
          }
        },
      ),
